...
class TestConcordantEC:
    ...
    def test_compute_rank_264_420(self):
        ...
        from rational_distance._legacy.concordant_ec import compute_rank
    ...
    def test_concordant_n_264_420(self):
        ...
        from rational_distance._legacy.concordant_ec import find_concordant_integers
    ...
    def test_chain_compatibility_known_failures(self):
        ...
        from rational_distance._legacy.concordant_ec import check_chain_compatibility
    ...
    def test_analyze_pair_no_normalize(self):
        ...
        from rational_distance._legacy.concordant_ec import analyze_pair
    ...
    def test_enumerate_multiples_finds_known(self):
        ...
        from rational_distance._legacy.concordant_ec import enumerate_multiples

        conc = enumerate_multiples(22, 35, max_depth=5)
        assert 120 in conc

    def test_is_perfect_square(self):
        from rational_distance._legacy.concordant_ec import _is_perfect_square
    ...
    def test_concordant_result_summary(self):
        ...
        from rational_distance._legacy.concordant_ec import ConcordantResult
...
class TestConcordantCompatibility:
    ...
    def test_legacy_and_new_import_paths_are_available(self):
        ...
        from rational_distance._legacy.concordant_ec import (
        ...
        from rational_distance._legacy.pair_generator import generate_ab_pairs as legacy_generate_ab_pairs
