...
def test_default_artifact_manifest_includes_priority_handoff_audit() -> None:
    ...
    assert (
        "scripts/theory/"
        "audit_closure_quotient_rank_zero_selmer_transcript_bridge.py"
        in paths
    )
    assert (
        "scripts/theory/"
    ...
    assert (
        "scripts/theory/"
        "audit_closure_quotient_rank_zero_selmer_bound_argument_queue.py"
        in paths
    )
    assert (
        "scripts/theory/"
        "audit_closure_quotient_rank_zero_selmer_bound_argument_sections.py"
        in paths
    )
    assert (
    ...
    assert "docs/work-logs/414-rank-zero-selmer-family-conclusion-templates.md" in paths
