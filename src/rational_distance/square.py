"""Deprecated stub. Real implementation: rational_distance._legacy.square.
...
keep working. New code should import from _legacy.square directly.
"""

import sys

from rational_distance._legacy import square as _impl
