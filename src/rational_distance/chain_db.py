"""Deprecated stub. Real implementation: rational_distance._legacy.chain_db.
...
keep working. New code should import from _legacy.chain_db directly.
"""

import sys

from rational_distance._legacy import chain_db as _impl
