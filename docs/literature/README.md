...
| Ono 1996 Acta Arithmetica 78 | ⭐⭐⭐ | 仅 abstract | `notes/ono-1996-concordant.md` |
| KSS 2019/2020 系列 | ⭐⭐ | abstract 读完 | `notes/knaf-selder-spindler.md` |
...
4. `ono-1996-concordant.md`（拿到全文后）— 协调形式问题的现代起点
...
- PDF 不入 git（受 `.gitignore` 控制），但 notes 里要记录 DOI / arXiv ID 让别人能找到
