...
uv run python scripts/theory/audit_closure_quotient_paper_claims.py \
  ...
  --expect language_audit_files=20 \
...
rank_zero_frontier_status.target_status_counts = {'not-retried': 1, 'sage-timeout': 7}
...
artifact_status.required_file_count = 138
...
`(8075,8613) AA`, `(391,9009) BB`, `(209,21735) BB`, and `(5083,12825) BB`, with `second_limit=13,20` and a
