...
records Sage retries on `(1625,5643) AA` and `(567,3757) BB` with
`second_limit=13,20` and a 120-second budget. Both timed out, so neither closed
the rank bound.
