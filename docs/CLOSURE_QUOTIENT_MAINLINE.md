...
uv run python scripts/theory/audit_closure_quotient_paper_claims.py \
  ...
  --expect language_audit_files=33 \
...
frontier_strictification_attempt_status.attempt_count=12
frontier_strictification_attempt_status.target_count_with_attempts=8
frontier_strictification_attempt_status.attempt_status_counts={'rank-method-open-not-proof': 8, 'rank-method-timeout-not-proof': 3, 'timeout-not-proof': 1}
...
artifact_status.required_file_count=236
