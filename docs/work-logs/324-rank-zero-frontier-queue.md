...
The attempted target was `(1625,5643) AA`, covering priorities `5` and `7`
with cover indices `3,4`. Sage did not close the rank bound within 120 seconds:
...
The remaining 7 rank targets are queued but not retried in this worklog:
