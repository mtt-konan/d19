...
covering priorities `12` and `19` with cover indices `3,4`. Sage did not close
any of these rank bounds:
...
The remaining 4 rank targets are queued but not retried yet:
