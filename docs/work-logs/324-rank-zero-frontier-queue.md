...
The eighth attempted target was `(5301,38675) BB`, covering priorities `22` and
`23` with cover indices `3,4`.
...
No rank-zero frontier target remains untried under this short Sage retry pass.
