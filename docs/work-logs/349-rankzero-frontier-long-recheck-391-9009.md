# Rank-Zero Frontier Long Recheck: 391,9009 BB

## Scope

Run a longer strictification attempt on the fifth rank-zero frontier target
`(391,9009) BB`, using the same 600-second rank-method budget as the preceding
long rechecks.
...
UV_CACHE_DIR=/private/tmp/d19-uv-cache DOT_SAGE=/private/tmp/d19-dot-sage uv run python scripts/theory/sage_probe_mixed_closure_rank_methods.py \
  --handoff results/mixed_closure_residual_handoffs/priority_013_391_9009_BB_covers_4_3.json \
  --out results/priority_013_391_9009_BB_rank_methods_t600_twodescent40.json \
  --sage sage \
  --timeout 600 \
  --method rank_proof \
  --method two_descent \
