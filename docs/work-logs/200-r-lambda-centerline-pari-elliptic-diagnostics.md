...
```text
本 wl 的 centerline 指几何中线在 R_lambda 里的 r=s 写法。
它是在补本地代数证明和假阳性解释，不是在说几何中线仍然开放。
几何中线 A=B / N1=N2 / a+b=2n 已由 Yang Ji 关闭；术语边界见 wl201。
```
