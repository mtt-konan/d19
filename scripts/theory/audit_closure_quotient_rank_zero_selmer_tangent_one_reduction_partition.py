#!/usr/bin/env python3
"""Audit tangent-one reduction-level squareclass partitions."""
...
BOUNDARY = (
    "This audits reduction-level squareclass partitions for the tangent-one "
    "standard nodal models. It records candidate squareclass sets only at the "
...
PARTITION_TARGETS = (
    {
        ...
        "nonnode_branch_id": "tangent-one-nonzero-double-root-nonnode-branch",
...
def audit_rank_zero_selmer_tangent_one_reduction_partition(
    *,
    nonnode_branches: dict[str, Any],
    node_values: dict[str, Any],
    punctured_nodes: dict[str, Any],
...
def main() -> int:
    ...
    print(f"wrote rank-zero Selmer tangent-one reduction partition to {args.out}")
