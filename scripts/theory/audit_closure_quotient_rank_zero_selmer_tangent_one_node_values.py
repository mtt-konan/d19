#!/usr/bin/env python3
"""Audit tangent-one standard model node reduction values."""
...
BOUNDARY = (
    "This audits reduction-level node values on the tangent-one standard nodal "
    "models. It proves only the displayed node coordinates and coordinate "
    "values; it does not prove node lift analysis, a local image, local "
...
NODE_VALUE_TARGETS = (
    {
        ...
        "remaining_gap": (
            "formal neighborhood of the node and tangent-squareclass -1 schemas"
        ),
    },
    {
...
def audit_rank_zero_selmer_tangent_one_node_values(
    *,
...
def main() -> int:
    ...
    print(f"wrote rank-zero Selmer tangent-one node value audit to {args.out}")
