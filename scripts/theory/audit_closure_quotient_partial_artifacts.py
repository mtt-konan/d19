...
DEFAULT_REQUIRED_ARTIFACTS: tuple[Artifact, ...] = (
    ...
    Artifact("script", "scripts/theory/audit_closure_quotient_c_ratio_coverage.py"),
    ...
    Artifact("test", "tests/test_closure_quotient_c_ratio_coverage.py"),
    ...
    Artifact("worklog", "docs/work-logs/408-closure-quotient-c-ratio-coverage.md"),
    ...
    Artifact(
        "worklog",
        "docs/work-logs/415-rank-zero-selmer-transcript-field-decomposition.md",
    ),
    Artifact(
        "worklog",
        "docs/work-logs/416-rank-zero-selmer-bound-argument-queue.md",
    ),
    Artifact(
        "worklog",
        "docs/work-logs/417-rank-zero-selmer-bound-argument-sections.md",
    ),
    Artifact(
        "worklog",
        "docs/work-logs/418-rank-zero-selmer-formal-lift-queue.md",
    ),
    ...
    Artifact(
        "worklog",
        "docs/work-logs/394-rank-zero-selmer-odd-prime-reduction-shapes.md",
    ),
    Artifact(
        "worklog",
    ...
    Artifact(
        "worklog",
        "docs/work-logs/397-rank-zero-selmer-tangent-one-normal-forms.md",
    ),
    Artifact(
        "worklog",
        "docs/work-logs/398-rank-zero-selmer-tangent-one-unit-branch.md",
    ),
    Artifact(
        "worklog",
        "docs/work-logs/399-rank-zero-selmer-tangent-one-nonnode-branches.md",
    ),
    Artifact(
        "worklog",
    ...
    Artifact(
        "worklog",
        "docs/work-logs/402-rank-zero-selmer-tangent-one-reduction-partition.md",
    ),
    Artifact(
        "worklog",
        "docs/work-logs/403-rank-zero-selmer-tangent-minus-one-normal-forms.md",
    ),
    Artifact(
        "worklog",
        "docs/work-logs/404-rank-zero-selmer-tangent-minus-one-nonnode-branches.md",
    ),
    Artifact(
        "worklog",
        "docs/work-logs/405-rank-zero-selmer-tangent-minus-one-node-values.md",
    ),
    Artifact(
        "worklog",
        "docs/work-logs/406-rank-zero-selmer-tangent-minus-one-punctured-nodes.md",
    ),
    Artifact(
        "worklog",
        "docs/work-logs/407-rank-zero-selmer-tangent-minus-one-reduction-partition.md",
    ),
    ...
    Artifact("result", "results/closure_quotient_c_ratio_coverage_audit.json"),
