...
def audit_rank_zero_selmer_tangent_one_unit_branch(
    *,
    ...
    return {
        ...
        "unit_branch_count": len(entries),
        "unit_branch_squareclass_consequence_proved_count": len(entries),
        "branch_results_not_local_images": True,
        "local_image_schema_proved_count": 0,
        "local_condition_proved_count": 0,
        "selmer_rank_upper_bound_proved_count": 0,
        "family_exclusion_proved_count": 0,
        "search_count_used_as_progress": False,
        "unit_branch_entries": entries,
...
def main() -> int:
    ...
    print(f"wrote rank-zero Selmer tangent-one unit branch audit to {args.out}")
    print(f"status={audit['status']}")
    print(f"input_normal_form_count={audit['input_normal_form_count']}")
    print(f"unit_branch_count={audit['unit_branch_count']}")
    print(
        "unit_branch_squareclass_consequence_proved_count="
        f"{audit['unit_branch_squareclass_consequence_proved_count']}"
    )
